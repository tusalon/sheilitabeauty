...
const urlsToCache = [
  ...
  '/sheilitha-beauty/utils/push-config.js',
  '/sheilitha-beauty/utils/push-notifications.js'
];
...
self.addEventListener('push', event => {
  ...
  const options = {
    ...
    icon: '/sheilitha-beauty/icons/icon-192x192.png',
    badge: '/sheilitha-beauty/icons/icon-96x96.png',
    tag: payload.tag || 'rservasroma',
    data: {
      url: payload.url || '/sheilitha-beauty/admin.html',
      ...(payload.data || {})
    }
  };
...
self.addEventListener('notificationclick', event => {
  ...
  const targetUrl = event.notification?.data?.url || '/sheilitha-beauty/admin.html';
  event.waitUntil(
